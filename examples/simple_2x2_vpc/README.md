...
Configuration in this directory creates a simple VPC with  2 public subnets and 2 private subnets

There is a public and private subnet created per availability zone in addition to single NAT Gateway shared between all 2 availability zones
